...
const HelpPage = () => {
  ...
  const helpSections = [
        ...
        <div className="space-y-6">
          <section>
            ...
            <ul className="list-disc pl-5 space-y-2 mb-4">
              ...
              <li><strong>Show promotion on detail page:</strong> Choose if you want this promotion displayed on your product detail page</li>
            </ul>
            
            <h4 className="font-semibold mt-6 mb-3">Step 4: Review Promotion</h4>
            <div className="border rounded-lg overflow-hidden mb-3">
              <img 
                src="/images/help/promotions-step4.png" 
                alt="Amazon Promotion Setup Step 4" 
            ...
            <h4 className="font-semibold mt-6 mb-3">Optional: Generating Promo Codes</h4>
            <p className="mb-3">If you chose Single-Use, you'll need to generate the unique claim codes for the promotion. Each shopper will get their own unique code to claim your promotion.</p>
            <ul className="list-disc pl-5 space-y-2 mb-4">
              <li><strong>Step 1:</strong> Click on Manage Your Promotions. If you don't see your newly created promotion, choose Pending from the drop down menu and click Search.</li>
              <li><strong>Step 2:</strong> Under Actions, click View</li>
              <li><strong>Step 3:</strong> Click on Manage Claim Codes.</li>
              <li><strong>Group Name:</strong> Give this set of claim codes a name</li>
              <li><strong>Quantity:</strong> Choose how many codes you'd like to generate</li>
              <li>Click Create</li>
              <li>Click Download and save the list of generated codes.</li>
            </ul>
            <p className="mb-3">Enter the codes in your promotion on ReviewBrothers. If you run out of codes, you can generate more codes on Amazon by following these steps and add them to your promotion at any time.</p>
          </section>
        </div>
      )
    },
    {
      id: "subscription",
      title: "Upgrade or Change Subscription Plans",
      content: (
        <div className="space-y-6">
          <section>
            <p className="mb-3">You can upgrade or change your subscription plan at any time by visiting your account plan page.</p>
            <p className="mb-3">If you decide to cancel or downgrade your subscription, your current active subscription plan will remain active until the expiration date.</p>
            <p className="mb-3">Once your current plan has expired, if you have any active campaigns, promotions, or products that exceed your new plans limits, they will be disabled and the associated live funnels will stop working.</p>
          </section>
        </div>
      )
    },
      ...
      content: (
        <div className="space-y-6">
          <section className="text-center">
            <p className="mb-6">If you have any question or comments, you can send them to our support team.</p>
            <Button 
              onClick={() => window.location.href = 'mailto:support@reviewbrothers.com'}
        ...
        <div className="container mx-auto px-4 pb-16">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              <h1 className="text-3xl md:text-4xl font-semibold mb-4">Knowledge Center</h1>
