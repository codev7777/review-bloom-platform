  ...
  const steps = [
    {
      ...
      description: "Set up review campaigns for specific products in your inventory",
      color: "bg-orange-50"
    },
    {
      icon: <QrCode className="h-10 w-10 text-[#146EB4]" />,
      title: "Generate QR Codes",
      description: "Place QR codes in your product packaging or email them to customers",
      color: "bg-blue-50"
    },
    {
      icon: <Smartphone className="h-10 w-10 text-[#232F3E]" />,
      title: "Customers Scan & Review",
      description: "Customers scan the code and leave their honest feedback about your product",
      color: "bg-gray-100"
    },
    {
      icon: <Star className="h-10 w-10 text-yellow-500" />,
      title: "Collect Amazon Reviews",
      description: "Positive reviews are redirected to post on Amazon, increasing your ratings",
      color: "bg-yellow-50"
    },
    {
    ...
    },
    {
      ...
      description: "Watch your sales increase as your review count and ratings improve",
      color: "bg-purple-50"
    }
  ];
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-10">
          {steps.map((step, index) => (
            <Card key={index} className="border border-border hover-lift animate-fade-in">
              <CardContent className="pt-6">
                <div className={`${step.color} p-3 rounded-full w-16 h-16 flex items-center justify-center mb-4`}>
                  {step.icon}
                </div>
        ...
        <div className="text-center mt-12">
          <Button asChild size="lg" className="bg-[#FF9900] hover:bg-orange-500 text-[#232F3E]">
